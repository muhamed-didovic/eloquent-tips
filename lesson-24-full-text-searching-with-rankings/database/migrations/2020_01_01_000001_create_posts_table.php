...
class CreatePostsTable extends Migration
{
    ...
    public function up()
    {
        ...
        if (config('database.default') === 'pgsql') {
            ...
            DB::statement("
            CREATE TRIGGER posts_searchable_update BEFORE INSERT OR UPDATE ON posts
            FOR EACH ROW EXECUTE PROCEDURE tsvector_update_trigger('searchable', 'pg_catalog.english', 'title', 'body')");
        }
    }
